...
import { ShoppingBag, Eye, Star, Zap, SlidersHorizontal, ArrowRight, Check } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-white/10 pb-6 gap-6">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#14161c] border border-white/10 px-3 py-1 rounded-full text-xs font-mono text-zinc-300 uppercase tracking-widest mb-3">
              ...
              <span>LAB-CALIBRATED APPAREL</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => {
            ...
            return (
              ...
              >
                {/* Top Image Box */}
                <div className="relative aspect-[4/3] bg-[#0b0c0e] overflow-hidden cursor-pointer" onClick={() => onSelectProduct(product)}>
                  <img
                  ...
                  <div className="absolute bottom-3 left-3 right-3 bg-black/80 backdrop-blur-md border border-white/10 p-2 rounded-lg flex items-center justify-between text-[11px] font-mono text-zinc-300 uppercase">
                    ...
                    <span className="text-emerald-400">TEMP: {product.specSheet.thermalDissipation}</span>
                  </div>
                </div>
